...
# ./cleos.sh system voteproducer $ACCOUNT_77 "1000.0000 CR" $ACCOUNT_77
...
# ./cleos.sh system voteproducer $ACCOUNT_78 "1000.0000 CR" $ACCOUNT_78
# ./cleos.sh system listproducers
...
# ./cleos.sh system voteproducer $ACCOUNT_79 "1000.0000 CR" $ACCOUNT_79
# ./cleos.sh system listproducers
...
# ./cleos.sh system voteproducer $ACCOUNT_86 "1000.0000 CR" $ACCOUNT_86
# ./cleos.sh system listproducers
...
# ./cleos.sh system voteproducer $ACCOUNT_87 "1000.0000 CR" $ACCOUNT_87
# ./cleos.sh system listproducers
...
# ./cleos.sh system voteproducer $ACCOUNT_88 "1000.0000 CR" $ACCOUNT_88
# ./cleos.sh system listproducers
...
# ./cleos.sh system voteproducer $ACCOUNT_80 "1000.0000 CR" $ACCOUNT_80
# ./cleos.sh system listproducers
